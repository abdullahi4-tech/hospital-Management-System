            ...
            <div class="col-md-12">
                <div class="box box-primary" >
                    <div class="box-header with-border">
                        <h3 class="box-title"> <?php echo $this->lang->line('inventory') . ' ' . $this->lang->line('stock') . ' ' . $this->lang->line('report'); ?></h3>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('available') . " " . $this->lang->line('quantity'); ?></th>                                       <th><?php echo $this->lang->line('total') . " " . $this->lang->line('quantity'); ?></th>
