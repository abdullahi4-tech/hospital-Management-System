                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('event', 'can_delete')) {
                                                        ?>
                                                        <a class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo site_url('admin/front/events/delete/' . $event['slug']); ?>', '<?php echo $this->lang->line('delete_message'); ?>')">
