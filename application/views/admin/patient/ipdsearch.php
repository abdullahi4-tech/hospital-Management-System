                                                ...
                                                <td>
                                                    ...
                                                    <div class="rowoptionview">       
                                                        <?php if ($this->rbac->hasPrivilege('consultant register', 'can_add')) { ?>
                                                            <a href="#" onclick="add_instruction('<?php echo $student['id']?>','<?php echo $student['ipdid']?>')" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('consultant') . " " . $this->lang->line('instruction'); ?>" >
