...
<html lang="en">
    ...
    <body>
                        ...
                        if (!$empty_notice) {
                            ...
                            <div class="col-lg-6 col-sm-6 col-sm-6">
                                <div class="loginright form-box  mCustomScrollbar">
                                    ...
                                    <!-- <img src="<?php echo base_url(); ?>styles/usertemplate/assets/img/backgrounds/bg3.jpg" class="img-responsive" style="border-radius:4px;" /> -->
                            </div><!--./col-lg-6-->
                            <?php
                        }
                        ?>
        ...
        <!-- <script src="<?php echo base_url(); ?>styles/usertemplate/assets/js/scripts.js"></script> -->
        <!--[if lt IE 10]>
            <script src="<?php echo base_url(); ?>styles/usertemplate/assets/js/placeholder.js"></script>
        <![endif]-->
    </body>
</html>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.backstretch([
            base_url + "styles/usertemplate/assets/img/backgrounds/11.jpg"
