            ...
            <div class="col-md-12">
                <div class="box box-primary" >
                    <div class="box-header with-border">
                        <h3 class="box-title"> <?php echo $this->lang->line('expense') . " " . $this->lang->line('group') . ' ' . $this->lang->line('report'); ?></h3>
                        <div class="box-tools pull-right">
                        </div>
                    </div>
                    <div class="box-body">
                        <form role="form" action="<?php echo site_url('admin/expense/expensegroup') ?>" method="post" class="">
                            <div class="row">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <div class="download_label"><?php echo $this->lang->line('expense') . " " . $this->lang->line('group') . ' ' . $this->lang->line('report'); ?></div>
